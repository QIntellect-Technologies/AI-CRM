...
export function Layout({ children, currentView, setCurrentView, selectedBranch = 'All Branches', setSelectedBranch = () => {} }: LayoutProps) {
  ...
  return (
    <div className="flex h-screen bg-navy-900 font-sans text-gray-200 overflow-hidden selection:bg-cyan-glow/30 selection:text-cyan-glow relative">
        ...
        <div className="mt-8 px-6 pt-6 border-t border-white/5 relative">
          ...
          <div className="flex items-center gap-3 p-4 rounded-2xl bg-navy-900/60 border border-white/10 hover:border-cyan-glow/30 transition-all cursor-pointer group shadow-[0_4px_15px_rgba(0,0,0,0.3)] hover:shadow-[0_4px_20px_rgba(0,212,255,0.15)] relative overflow-hidden">
            ...
            <div className="relative">
              ...
              <img src="https://randomuser.me/api/portraits/men/32.jpg" alt="Agent" className="relative w-11 h-11 rounded-full object-cover border-2 border-navy-900 shadow-md group-hover:border-cyan-glow/50 transition-colors" />
      ...
      {/* Main Content Area */}
      <main className="flex-1 h-screen overflow-y-auto overflow-x-hidden relative custom-scrollbar bg-navy-950">
        <header className="sticky top-0 shrink-0 z-[60] bg-navy-950/70 backdrop-blur-3xl border-b border-white/5 shadow-[0_10px_40px_rgba(0,0,0,0.3)] h-24 flex items-center justify-between px-8 transition-all">
              ...
              {branchOpen && (
                <>
                  <div className="fixed inset-0 z-[90]" onClick={() => setBranchOpen(false)}></div>
                    <div className="fixed top-[96px] left-[50%] -translate-x-[25%] mt-1 w-56 glass-panel bg-navy-900/95 backdrop-blur-xl border border-white/10 shadow-[0_15px_50px_rgba(0,0,0,0.5)] rounded-2xl py-2 z-[100] animate-in fade-in slide-in-from-top-2 duration-200">
          ...
          <div className="flex items-center gap-5">
            ...
            <div className="relative group cursor-pointer">
              ...
              {notificationsOpen && (
                <>
                  ...
                  <div className="fixed top-[96px] right-20 mt-1 w-96 glass-panel bg-navy-900/95 backdrop-blur-2xl border border-white/10 rounded-2xl p-5 shadow-[0_15px_50px_rgba(0,0,0,0.6)] animate-in fade-in slide-in-from-top-2 duration-200 z-[100]">
            ...
            <button className="flex items-center gap-3 bg-white/5 hover:bg-white/10 p-1.5 pr-4 rounded-full border border-white/5 hover:border-white/10 transition-all group">
              <div className="relative">
                <img src="https://randomuser.me/api/portraits/men/32.jpg" alt="User" className="w-10 h-10 rounded-full object-cover border border-white/20 group-hover:border-cyan-glow/50 transition-colors shadow-lg" />
                <div className="absolute bottom-0 right-0 w-3 h-3 bg-emerald-glow rounded-full border-2 border-navy-950 shadow-[0_0_8px_rgba(0,229,160,0.8)]"></div>
              </div>
        ...
        {/* Page Content */}
        <div className="p-8 pb-20 max-w-[1600px] mx-auto relative z-10 w-full animate-in fade-in duration-500">
          {/* Subtle background glow effect for beauty */}
          <div className="fixed top-0 left-1/2 -translate-x-1/2 w-full h-[500px] bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-cyan-900/10 via-transparent to-transparent pointer-events-none -z-10"></div>
          {children}
        </div>
      </main>
    </div>
