...
export function Patients({
  ...
  onPatientSelect?: (id: string | number) => void;
  ...
  useEffect(() => {
    fetchPatients();
    const handleMutation = () => fetchPatients();
    ...
    <div className="space-y-6 max-w-7xl mx-auto pb-10">
      ...
      {loading ? (
        <div className="flex h-[60vh] items-center justify-center">
            <GlobalLoader label="Synchronizing Patient Records..." subLabel="Fetching EMR and scheduled visits" />
        </div>
      ) : (
        <>
