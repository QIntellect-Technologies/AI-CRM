...
export function PatientDetails({ patientId, onBack, selectedBranch }: { patientId: string | number; onBack: () => void; selectedBranch?: string }) {
  ...
  if (loading || !patient) {
    return <GlobalLoader label="Loading Patient Record..." subLabel="Decrypting EMR data streams" />;
  }
