...
export function Marketing() {
  ...
  // Beautiful hardcoded trend data for the AreaChart
  const trendData = [
    { month: 'Jan', leads: 400, spend: 1200 },
    { month: 'Feb', leads: 600, spend: 1500 },
    { month: 'Mar', leads: 850, spend: 1800 },
    { month: 'Apr', leads: 1100, spend: 2000 },
    { month: 'May', leads: 1400, spend: 2300 },
    { month: 'Jun', leads: 1800, spend: 2600 },
    { month: 'Jul', leads: 2340, spend: 3100 },
  ];
