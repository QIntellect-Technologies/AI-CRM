...
export function Patients({ onPatientSelect }: { onPatientSelect?: (id: number | string) => void }) {
    ...
    <div className="space-y-6 max-w-7xl mx-auto pb-10">
      ...
      <div className="sticky top-[96px] z-[50] bg-navy-950/90 backdrop-blur-2xl pb-4 pt-4 -mx-8 px-8 rounded-b-2xl shadow-[0_20px_40px_rgba(0,0,0,0.6)] border-b border-light-blue/10 transition-all">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div>
            <h1 className="text-3xl font-bold text-white tracking-tight">Patient Management</h1>
            <p className="text-gray-400 mt-1">View and manage patient records, history, and engagement.</p>
          </div>
          <button
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mt-6">
          <div className="glass-card rounded-2xl p-5 border border-white/5 relative overflow-hidden group hover:border-cyan-glow/30 transition-colors bg-navy-900/50 backdrop-blur-sm">
            ...
            <div className="flex justify-between items-start relative z-10">
              <div>
                <p className="text-gray-400 text-sm font-medium mb-1">Total Patients</p>
          ...
          <div className="glass-card rounded-2xl p-5 border border-white/5 relative overflow-hidden group hover:border-amber-500/30 transition-colors bg-navy-900/50 backdrop-blur-sm">
            ...
            <div className="flex justify-between items-start relative z-10">
              <div>
                <p className="text-gray-400 text-sm font-medium mb-1">Gold Tier (High Value)</p>
                <h3 className="text-3xl font-bold text-white">{stats.highValue}</h3>
              </div>
                ...
                >
                  <td className="px-6 py-4">
                    <div className="flex items-center gap-3">
                      <img src={getAvatarUrl(patient.name, patient.id)} alt={patient.name} className="w-10 h-10 rounded-full object-cover border border-white/10" />
                      <div>
