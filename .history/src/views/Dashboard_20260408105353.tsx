  ...
  return (
    <div className="flex flex-col space-y-8 pb-20 relative">
          ...
          <div className="relative z-10 w-full flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
            ...
            <div className="flex items-center gap-5 shrink-0 bg-navy-800/40 p-4 rounded-2xl border border-white/5 shadow-lg">
              ...
              <div className="flex items-center gap-2">
                ...
                <button className="p-2.5 bg-white/5 hover:bg-purple-500/10 border border-white/10 hover:border-purple-500/30 rounded-xl transition-all text-gray-400 hover:text-purple-400 group">
                  <Bell size={16} className="group-hover:scale-110 transition-transform" />
                </button>
                <button className="ml-1 px-4 py-2.5 bg-gradient-to-r from-emerald-600 to-emerald-400 hover:from-emerald-500 hover:to-emerald-300 text-white font-bold rounded-xl transition-all shadow-[0_0_15px_rgba(0,229,160,0.3)] hover:shadow-[0_0_20px_rgba(0,229,160,0.5)] flex items-center gap-2 text-sm">
        ...
        <div className="xl:col-span-2 space-y-6">
          ...
          <div className="glass-panel p-8 rounded-3xl group overflow-hidden border-cyan-glow/20 shadow-[0_0_30px_rgba(0,212,255,0.1)] relative">
            ...
            <div className="flex items-center justify-between mb-8 relative z-10 border-b border-white/5 pb-4">
              ...
              <div className="flex gap-2 bg-cyan-glow/5 px-3 py-1.5 rounded-full border border-cyan-glow/20 shadow-[0_0_10px_rgba(0,212,255,0.1)]">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mt-6">
        ...
        <div className="glass-panel p-8 rounded-3xl relative group flex flex-col h-full">
