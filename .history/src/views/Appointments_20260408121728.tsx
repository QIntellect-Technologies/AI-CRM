...
export function Appointments() {
  ...
  return (
    <div className="space-y-6 max-w-7xl mx-auto relative pb-10 fade-in duration-300">
      ...
      {/* Sticky Header & KPIs */}
      <div className="sticky top-0 z-[50] bg-navy-950/80 backdrop-blur-xl pb-4 pt-4 sm:-mx-4 px-0 sm:px-4 -mx-0 shadow-[0_10px_40px_rgba(0,0,0,0.4)] border-b border-white/5 transition-all">
