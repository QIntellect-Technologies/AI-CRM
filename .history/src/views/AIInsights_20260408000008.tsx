...
export function AIInsights() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const [insightsData, marketingDataRes] = await Promise.all([
          api.getAIInsights(),
          api.getMarketing()
        ]);
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="glass-card rounded-2xl p-6 border-cyan-glow/20 hover:border-cyan-glow/40 shadow-[0_0_15px_rgba(0,212,255,0.05)] relative overflow-hidden group">
          ...
          <p className="text-sm text-gray-400 leading-relaxed mb-6 relative z-10">
            {insights.marketing || 'TikTok campaigns are currently yielding the highest quality leads (Avg Score: 85). Consider reallocating 15% of Snapchat budget to TikTok for the weekend.'}
          </p>
        ...
        <div className="glass-card rounded-2xl p-6 border-emerald-glow/20 hover:border-emerald-glow/40 shadow-[0_0_15px_rgba(0,229,160,0.05)] relative overflow-hidden group">
          ...
          <p className="text-sm text-gray-400 leading-relaxed mb-6 relative z-10">
            {insights.retention || 'Identified 42 patients at risk of churn (inactive >45 days). An automated SMS campaign offering a free consultation could recover ~15% of them.'}
          </p>
        ...
        <div className="glass-card rounded-2xl p-6 border-purple-500/20 hover:border-purple-500/40 shadow-[0_0_15px_rgba(168,85,247,0.05)] relative overflow-hidden group">
          ...
          <p className="text-sm text-gray-400 leading-relaxed mb-6 relative z-10">
            {insights.forecasting || 'Based on current lead velocity and historical conversion rates, expect a 12% increase in scheduled appointments next week. Ensure adequate staffing.'}
          </p>
