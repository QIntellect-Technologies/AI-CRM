...
export function Dashboard() {
  ...
  return (
    <div className="flex flex-col h-full space-y-8 pb-20 relative">
      ...
      <div className="glass-panel p-8 rounded-3xl relative flex items-center justify-between">
        ...
        <div className="hidden lg:flex items-center gap-4 relative z-10">
          <div className="text-right">
            <p className="text-xs text-gray-500 uppercase tracking-wider font-bold mb-1">System Status</p>
            <div className="flex items-center gap-2">
              <div className="flex bg-emerald-glow/20 border border-emerald-glow/30 px-3 py-1.5 rounded-lg items-center gap-2 shadow-[0_0_20px_rgba(0,229,160,0.15)]">
                ...
                <span className="text-sm font-bold text-emerald-400">All Operations Optimal</span>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 xl:grid-cols-5 gap-6">
        ...
        <div className="xl:col-span-2 space-y-6">
          ...
          {/* AI INSIGHTS CARD */}
          <div className="glass-panel p-8 rounded-3xl relative group overflow-hidden border-cyan-glow/20 shadow-[0_0_30px_rgba(0,212,255,0.05)] relative overflow-hidden">
