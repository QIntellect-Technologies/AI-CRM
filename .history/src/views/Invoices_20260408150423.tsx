  ...
  return (
    <div className="space-y-6 max-w-7xl mx-auto h-full flex flex-col pb-10">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
        ...
        {/* Left Side: Chart */}
        <div className="glass-panel p-5 rounded-2xl border border-white/5 lg:col-span-1 flex flex-col justify-between">
            <h3 className="text-sm font-bold text-white mb-4 flex items-center gap-2 tracking-wide uppercase">
               Weekly Processing <Briefcase size={14} className="text-cyan-400" />
            </h3>
            <div className="h-full min-h-[250px] w-full">
              <ResponsiveContainer width="100%" height="100%">
                  <BarChart data={revenueData} margin={{ top: 0, right: 0, left: -25, bottom: 0 }}>
                    ...
                    />
                    <Bar dataKey="revenue" fill="#06b6d4" radius={[4, 4, 0, 0]} barSize={12} />
                  </BarChart>
              </ResponsiveContainer>
            </div>
        </div>
                ...
                <table className="w-full text-left border-collapse min-w-[800px]">
                  ...
                  <tbody className="divide-y divide-white/5">
                    {filteredInvoices.map((invoice, idx) => (
                      <tr key={invoice.id || idx} className="hover:bg-white/[0.02] transition-colors group cursor-pointer">
