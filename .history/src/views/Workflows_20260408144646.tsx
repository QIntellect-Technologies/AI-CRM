...
export function Workflows({ selectedBranch }: { selectedBranch?: string }) {
        ...
        <div className="grid grid-cols-1 gap-4">
          <div className="glass-panel p-6 rounded-2xl flex flex-col gap-4 border border-white/5 relative overflow-hidden group">
            ...
            {workflows.map((wf) => {
              ...
              return (
                <div key={wf.id} className="bg-navy-900 border border-white/10 rounded-xl p-4 flex flex-col lg:flex-row items-start lg:items-center justify-between gap-6 hover:border-cyan-glow/30 transition-colors relative z-10">
                  
                  {/* Icon & Details */}
                  <div className="flex items-start gap-4 flex-1">
                    <div className="p-3 rounded-xl bg-navy-800 border border-white/5 mt-1">
                  ...
                  <div className="flex items-center justify-between lg:justify-end gap-3 w-full lg:w-auto">
                    <span className={cn(
                      "text-xs font-bold px-3 py-1.5 rounded-md uppercase tracking-wider border",
            ...
            <form onSubmit={handleAddSubmit} className="p-6 space-y-5">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                ...
                <div className="space-y-2">
                  ...
                  <select
                    ...
                    className="w-full bg-navy-900 border border-white/10 rounded-lg px-4 py-2.5 text-white focus:outline-none focus:border-cyan-glow/50"
                  >
                    <option value="appointment_booked">Appointment Booked</option>
                    <option value="appointment_missed">Appointment Missed</option>
                    <option value="inactivity_detected">Patient Inactivity (6 Mo)</option>
                ...
                <div className="space-y-2">
                  ...
                  <select
                    ...
                    className="w-full bg-navy-900 border border-white/10 rounded-lg px-4 py-2.5 text-white focus:outline-none focus:border-cyan-glow/50"
                  >
                    <option value="all_active">Active Members (All)</option>
                    <option value="inactive">Inactive / Lost Members</option>
                    <option value="loyal">Loyal VIP Members (10+ Visits)</option>
                    <option value="new">New Patients (0 Visits)</option>
                  </select>
                </div>
              ...
              <div className="pt-4 flex justify-end gap-3">
                ...
                >
                  ...
                  {isSubmitting ? 'Creating...' : 'Deploy Automation'}
                </button>
              </div>
