...
export function Appointments() {
  ...
  return (
    <div className="space-y-6 max-w-7xl mx-auto relative pb-10 fade-in duration-300">
      ...
      {/* Sticky Header & KPIs */}
      <div className="sticky top-24 z-[50] bg-navy-950/90 backdrop-blur-2xl pb-4 pt-4 -mx-4 px-4 sm:-mx-8 sm:px-8 rounded-b-2xl shadow-[0_10px_40px_rgba(0,0,0,0.5)] border-b border-white/10 transition-all">
