              ...
              >
                ...
                <div className="flex items-center justify-between pt-4 border-t border-white/5 relative z-10">
                   ...
                   <div className="flex gap-2">
                     {agent.sentiment === 'Frustrated' && (
                       <button onClick={() => handleBarge(agent.id)} className="text-xs font-bold px-3 py-1.5 bg-red-500 text-white rounded-lg transition-all hover:bg-red-400 shadow-[0_0_15px_rgba(239,68,68,0.4)] animate-bounce">
                         Barge In
                       </button>
                     )}
