...
export function Appointments({ onPatientSelect, selectedBranch }: { onPatientSelect?: (id: string | number) => void, selectedBranch?: string }) {
        ...
        <div className="divide-y divide-white/5">
          {loading ? (
            <div className="flex h-[60vh] items-center justify-center">
              <GlobalLoader label="Loading Schedule..." subLabel="Fetching appointment clusters" />
            </div>
            ...
            filteredAppointments.map((apt) => {
              ...
              return (
                <div
                  ...
                  onClick={() => onPatientSelect ? onPatientSelect(apt.patient_id || apt.id) : setSelectedAppointment(apt)}
                >
