...
// Mock Data for Analytics & Live Queue
const hourlyVolume = [
  { time: '08:00', calls: 12, missed: 2 }, { time: '09:00', calls: 25, missed: 4 },
  { time: '10:00', calls: 48, missed: 8 }, { time: '11:00', calls: 56, missed: 10 },
  { time: '12:00', calls: 42, missed: 5 }, { time: '13:00', calls: 30, missed: 2 },
  { time: '14:00', calls: 58, missed: 11 }, { time: '15:00', calls: 64, missed: 15 },
  { time: '16:00', calls: 45, missed: 6 }, { time: '17:00', calls: 35, missed: 3 },
];

const callDispositions = [
  { name: 'Sales Inquiry', value: 45, color: '#10b981' },
  { name: 'Support / Tech', value: 30, color: '#3b82f6' },
  { name: 'Billing Question', value: 15, color: '#8b5cf6' },
...
const liveQueue = [
  ...
  { id: 'Q3', caller: '+1 (555) 992-1102', waitTime: 45, status: 'Normal', intent: 'Unknown' },
];
...
export function CallCenter() {
  ...
  const processedCalls = recordings.map(c => {
    ...
    let disposition = callDispositions[Math.floor(Math.random() * callDispositions.length)].name;
