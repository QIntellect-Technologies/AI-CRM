              ...
              {notificationsOpen && (
                <>
                  <div className="fixed inset-0 z-[90]" onClick={() => setNotificationsOpen(false)}></div>
                    <div className="absolute top-[calc(100%+26px)] right-0 w-96 glass-panel bg-navy-900/95 backdrop-blur-2xl border border-white/10 rounded-2xl p-5 shadow-[0_15px_50px_rgba(0,0,0,0.6)] animate-in fade-in slide-in-from-top-2 duration-200 z-[100]">
