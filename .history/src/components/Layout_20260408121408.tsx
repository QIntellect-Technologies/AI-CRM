...
export function Layout({ children, currentView, setCurrentView }: LayoutProps) {
  ...
  return (
    <div className="flex h-screen bg-navy-900 font-sans text-gray-200 overflow-hidden selection:bg-cyan-glow/30 selection:text-cyan-glow relative">
      ...
      {/* Main Content Area */}
      <main className="flex-1 flex flex-col h-screen overflow-hidden z-10 relative bg-navy-950">
        <header className="shrink-0 z-[60] bg-navy-950/70 backdrop-blur-3xl border-b border-white/5 shadow-[0_10px_40px_rgba(0,0,0,0.3)] h-24 flex items-center justify-between px-8 transition-all relative">
