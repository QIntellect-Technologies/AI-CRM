              ...
              {branchOpen && (
                <>
                  <div className="fixed inset-0 z-[90]" onClick={() => setBranchOpen(false)}></div>
                    <div className="fixed top-24 mt-2 left-1/2 -translate-x-1/2 w-56 glass-panel bg-navy-900/95 backdrop-blur-xl border border-white/10 shadow-[0_15px_50px_rgba(0,0,0,0.5)] rounded-2xl py-2 z-[100] animate-in fade-in slide-in-from-top-2 duration-200">
