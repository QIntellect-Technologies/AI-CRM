      ...
      <main className="flex-1 flex flex-col h-screen overflow-hidden z-10 relative">
        ...
        <header className="h-24 flex items-center justify-between px-8 shrink-0 relative z-50 bg-gradient-to-b from-navy-900/90 to-navy-800/40 backdrop-blur-2xl border-b border-light-glow/5 shadow-[0_4px_30px_rgba(0,0,0,0.2)]">
          ...
          <div className="flex items-center gap-4">
            <div className="p-2.5 bg-navy-800/80 rounded-xl border border-white/10 shadow-lg">
              <LayoutDashboard size={22} className="text-cyan-glow" />
            </div>
            <div className="flex flex-col justify-center">
              <div className="flex items-center gap-2 text-xs text-gray-400 font-medium mb-0.5">
                <span className="hover:text-gray-200 cursor-pointer transition-colors">Workspace</span>
                <span className="text-gray-600">/</span>
                <span className="text-cyan-glow capitalize">{currentView.replace('-', ' ')}</span>
              </div>
              <h2 className="text-2xl font-heading font-bold text-white capitalize tracking-wide">
                {currentView.replace('-', ' ')}
              </h2>
            </div>
          </div>
